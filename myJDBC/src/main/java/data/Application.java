...
public class Application implements CommandLineRunner {
	...
	public void run (String... strings) throws Exception{
		...
		log.info("Creating table");
		 ...
		 jdbcTemplate.query("SELECT * FROM movies WHERE lead_actor = ?", new Object[] {"Tom Cruise"},
				 (rs, rowNum) -> new Movie(rs.getLong("id"), rs.getString("title"), rs.getString("lead_actor"))
